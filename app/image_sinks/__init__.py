...
See :mod:`app.image_sinks.base` for the ``ImageSink`` Protocol
and :mod:`app.image_sinks.factory` for ``get_image_sink``.
"""
...
from app.image_sinks.factory import get_image_sink
