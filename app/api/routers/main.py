...
from app.api.routers import auth, camera, images, metrics, stream, telemetry, whep
...
for r in [camera.router, images.router, stream.router, telemetry.router, whep.router]:
