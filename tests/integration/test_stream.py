...
class TestStreamStatus:
    ...
    async def test_no_active_stream_returns_404(self, client: AsyncClient) -> None:
        ...
        resp = await client.get("/streams/youtube")
...
class TestStreamStop:
    """Tests for DELETE /streams/youtube."""
...
class TestStreamStartErrorPaths:
    """``POST /streams/youtube`` should translate backend exceptions into HTTP errors."""
